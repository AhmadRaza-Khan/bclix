...
const SearchApi = () => {
  ...
  return (
    ...
    <SearchIcon onClick={handleSearchClick} className={`absolute top-4 right-20 scale-125 hover:cursor-pointer hover:scale-150 ${search.length == 0 ?  "opacity-50" : ""}`}/>
      </div>
      <div ref={notFoundRef} className="  py-2 px-5 text-lg rounded-xl mt-5 text-red-500"></div>
